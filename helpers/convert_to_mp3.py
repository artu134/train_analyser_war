...
source_path = "C:/Users/IronTony/Projects/data/dataset/train/"

# Replace with the output directory
out_path = "C:/Users/IronTony/Projects/data/dataset/train_mp3/"
...
def process_folder(fol="balanced_train_segments"):
    ...
    all_files = [
        os.path.join(source_path, fol, file_name) for file_name in
        os.listdir(os.path.join(source_path, fol)) if file_name[-4:] == ".wav"
    ]
